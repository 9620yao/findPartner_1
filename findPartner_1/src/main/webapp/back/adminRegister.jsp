...
<body>
	<header>
		...
		<div class="log-re">
		 	<a href="page/lw-log.jsp" style="display: block;" class="am-btn am-btn-default am-radius log-button">登 录</a>
		</div>
	</header>
			...
			<div
				...
				<form class="am-form" id="log-form" action="partner/register" method="post">
					...
					<div class="am-input-group am-radius am-animation-slide-left">
						<input name="email" type="email" id="doc-vld-email-2-1" class="am-radius"
